...
public class SpiritualityAdapter extends RecyclerView.Adapter<SpiritualityAdapter.MyViewHolder> {
    ...
    public SpiritualityAdapter(Context c , ArrayList<Profile> p)
    {
        context = c;
        profiles = p;
    }
