...
public class NatureAdapter extends RecyclerView.Adapter<NatureAdapter.MyViewHolder> {
    ...
    public NatureAdapter(Context c , ArrayList<Profile> p)
    {
        context = c;
        profiles = p;
    }
