...
import com.example.bottombar_navigation_with_fragment.Places;
...
public class AttractionAdapter extends RecyclerView.Adapter<AttractionAdapter.MyViewHolder> {
    ...
    public AttractionAdapter(Context c , ArrayList<Profile> p)
    {
        context = c;
        profiles = p;
    }
        ...
        public MyViewHolder(View itemView) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    i.putExtra("CAT1", "Places");
                    i.putExtra("CAT2", "Attraction");
